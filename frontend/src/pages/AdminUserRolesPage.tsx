...
import { useGetAllUsersWithRoles, useAssignUserRole, useDeleteUser, useIsCallerAdmin } from '../hooks/useQueries';
...
export default function AdminUserRolesPage() {
  ...
  const { data: users = [], isLoading: usersLoading, error: usersError } = useGetAllUsersWithRoles(!!isAdmin);
    ...
    <div className="min-h-screen py-12">
      <div className="container max-w-5xl space-y-8">
        <div className="space-y-2">
          ...
          <h1 className="font-display text-4xl font-bold">User Role Management</h1>
          <p className="text-muted-foreground">
            Manage user roles and permissions for Sound Waves Publishing &amp; Media.
          </p>
        </div>
                            ...
                            <div className="flex items-center justify-end gap-2">
                              {isEditing ? (
                                <>
                                  ...
                                  >
                                    {assignRole.isPending ? <Loader2 className="h-3 w-3 animate-spin" /> : 'Save'}
                                  </Button>
                                  <Button
                                    size="sm"
                                    variant="outline"
