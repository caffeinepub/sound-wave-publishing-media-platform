...
import { useGetAllArtistProfiles, useCreateMembershipFeeRecord, useUpdateMembershipFeeRecord } from '../../hooks/useQueries';
...
export default function MembershipFeeRecordDialog({ open, onOpenChange, editingRecord }: MembershipFeeRecordDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          <DialogTitle>{editingRecord ? 'Edit Membership Fee Record' : 'Add Membership Fee Record'}</DialogTitle>
          <DialogDescription>
            Record a $40 membership fee payment to RTS Enterprises Sound Waves Publishing and Media.
          </DialogDescription>
        </DialogHeader>
