...
export default function MediaDetailPage() {
  ...
  const [selectedPaymentMethod, setSelectedPaymentMethod] = useState<
    "stripe" | "merchantServices" | "nationalBankcard"
  >("stripe");
  ...
  const hasPaymentGateways =
    stripeConfigured || merchantConfigured || nationalBankcardConfigured;
  const availableGateways = [
    ...
    nationalBankcardConfigured && {
      value: "nationalBankcard",
      label: "National Bankcard",
      icon: CreditCard,
    },
            ...
            <Card className="mt-6">
              ...
              <CardContent>
                <a
                  ...
                  className="flex cursor-pointer items-start gap-4 transition-opacity hover:opacity-80 no-underline"
                  onClick={(e) => {
                    e.preventDefault();
                    navigate({
                      to: "/artist/$artistId",
          ...
          <Card className="sticky top-20">
            ...
            <CardContent className="space-y-4">
              {media.licensingOptions.length === 0 ? (
                <p className="text-sm text-muted-foreground">
                  No licensing options available
                </p>
              ) : (
                <>
                      ...
                      <CardContent className="p-4">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <Button
                            ...
                            disabled={
                              createCheckout.isPending || !hasPaymentGateways
                            }
                            size="sm"
                          >
                  ...
                  {!hasPaymentGateways && (
                    <p className="text-xs text-muted-foreground">
                      Payment processing is not yet configured. Please contact
                      the administrator.
                    </p>
                  )}
                </>
