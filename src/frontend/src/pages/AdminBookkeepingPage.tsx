...
export default function AdminBookkeepingPage() {
  ...
  const [editingMembershipFee, setEditingMembershipFee] =
    useState<MembershipFeeRecord | null>(null);
  ...
  const handleDeleteMembershipFee = async (id: string) => {
    if (!confirm("Are you sure you want to delete this membership fee record?"))
      return;
    try {
    ...
    <div className="container py-8">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground mt-2">
          Manage membership fees, invoices, and payouts for RTS Enterprises
          Sound Waves Publishing and Media.
        </p>
      </div>
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>
                    Track $40 membership fees paid to RTS Enterprises.
                  </CardDescription>
                </div>
                <Button
                  onClick={() => setMembershipFeeDialogOpen(true)}
                  size="sm"
                >
            ...
            <CardContent>
              {feesError ? (
                <Alert variant="destructive">
                  ...
                  <AlertDescription>
                    Failed to load membership fee records:{" "}
                    {feesError instanceof Error
                      ? feesError.message
                      : "Unknown error"}
                        ...
                        <TableCell className="text-right">
                          <div className="flex justify-end gap-2">
                            <Button
                              variant="ghost"
                              size="sm"
                              onClick={() => handleEditMembershipFee(record)}
                            >
                            ...
                            <Button
                              ...
                              size="sm"
                              onClick={() =>
                                handleDeleteMembershipFee(record.id)
                              }
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>
                    Track invoices for artist services and media.
                  </CardDescription>
                </div>
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>
                    Track artist payouts and financial transactions.
                  </CardDescription>
                </div>
                        ...
                        <TableCell className="text-right">
                          <div className="flex justify-end gap-2">
                            <Button
                              variant="ghost"
                              size="sm"
                              onClick={() => handleEditPayout(record)}
                            >
                              <Pencil className="h-4 w-4" />
                            </Button>
                            <Button
      ...
      <InvoiceRecordDialog
        ...
        editingRecord={editingInvoice}
      />
      <PayoutRecordDialog
        open={payoutDialogOpen}
        onOpenChange={handlePayoutDialogClose}
        editingRecord={editingPayout}
      />
    </div>
  );
}
