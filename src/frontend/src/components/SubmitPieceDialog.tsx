...
export default function SubmitPieceDialog({
  open,
  onOpenChange,
  onSuccess,
}: SubmitPieceDialogProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Add a new musical piece to your portfolio. You need 15 pieces to
            become eligible for share purchases.
          </DialogDescription>
        </DialogHeader>
