    ...
    <Dialog open={true}>
      ...
      >
        <DialogHeader>
          ...
          <DialogDescription>
            Set up National Bankcard to enable additional payment options.
          </DialogDescription>
        </DialogHeader>
        <Alert>
          <AlertCircle className="h-4 w-4" />
          <AlertDescription className="text-xs">
            You need a National Bankcard merchant account. Get your API
            credentials from the National Bankcard dashboard.
          </AlertDescription>
        </Alert>
