...
import { CheckCircle2, CreditCard, Settings, XCircle } from "lucide-react";
...
export default function PaymentSettingsDialog() {
  ...
  const { data: nationalBankcardConfigured } =
    useIsNationalBankcardConfigured();
  ...
  const [nationalEndpoint, setNationalEndpoint] = useState(
    "https://api.nationalbankcard.com/v1",
  );
  const [nationalCountries, setNationalCountries] = useState(
    "US,CA,GB,AU,DE,FR,ES,IT,NL,SE",
  );
        ...
        <div className="space-y-6">
            ...
            <CardContent>
              <form onSubmit={handleMerchantSubmit} className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  />
                  <p className="text-xs text-muted-foreground">
                    Use test endpoint for sandbox, production for live
                  </p>
                </div>
                <div className="space-y-2">
                  <Label htmlFor="merchantCountries">
                    Allowed Countries (comma-separated)
                  </Label>
                  <Input
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Configure National Bankcard payment processing
              </CardDescription>
            </CardHeader>
            <CardContent>
              <form
                onSubmit={handleNationalBankcardSubmit}
                className="space-y-4"
              >
                <div className="space-y-2">
                ...
                <div className="space-y-2">
                  <Label htmlFor="nationalCountries">
                    Allowed Countries (comma-separated)
                  </Label>
                  <Input
                ...
                <Button
                  type="submit"
                  disabled={setNationalBankcardConfig.isPending}
                >
