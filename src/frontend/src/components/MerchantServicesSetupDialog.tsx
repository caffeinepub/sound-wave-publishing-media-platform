    ...
    <Dialog open={true}>
      ...
      >
        <DialogHeader>
          ...
          <DialogDescription>
            Set up Authorize.net to enable additional payment options.
          </DialogDescription>
        </DialogHeader>
        <Alert>
          <AlertCircle className="h-4 w-4" />
          <AlertDescription className="text-xs">
            You need an Authorize.net merchant account. Get your API credentials
            from the Authorize.net dashboard.
          </AlertDescription>
        </Alert>
