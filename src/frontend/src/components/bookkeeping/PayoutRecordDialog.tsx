...
import {
  useCreatePayoutRecord,
  useGetAllArtistProfiles,
  useGetAllMedia,
  useUpdatePayoutRecord,
...
export default function PayoutRecordDialog({
  open,
  onOpenChange,
  editingRecord,
}: PayoutRecordDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          <DialogTitle>
            {editingRecord ? "Edit Payout Record" : "Add Payout Record"}
          </DialogTitle>
          <DialogDescription>
            Record an artist payout or financial transaction.
          </DialogDescription>
        </DialogHeader>
        <form onSubmit={handleSubmit}>
          <div className="space-y-4 py-4">
            ...
            <div className="space-y-2">
              ...
              <Select
                value={associatedMediaId}
                onValueChange={setAssociatedMediaId}
              >
