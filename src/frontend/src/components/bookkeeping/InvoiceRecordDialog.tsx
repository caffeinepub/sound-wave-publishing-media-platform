...
import {
  useCreateInvoiceRecord,
  useGetAllArtistProfiles,
  useGetAllMedia,
  useUpdateInvoiceRecord,
...
export default function InvoiceRecordDialog({
  open,
  onOpenChange,
  editingRecord,
}: InvoiceRecordDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          <DialogTitle>
            {editingRecord ? "Edit Invoice Record" : "Add Invoice Record"}
          </DialogTitle>
          <DialogDescription>
            Record an invoice for artist services or media.
          </DialogDescription>
        </DialogHeader>
